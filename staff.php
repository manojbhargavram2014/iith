      ...
      <div class="gdlr-core-pbf-sidebar-content  gdlr-core-column-30 gdlr-core-pbf-sidebar-padding gdlr-core-line-height gdlr-core-column-extend-left" style="padding: 40px 0px 0px 0px;">
         <div class="gdlr-core-pbf-sidebar-content-inner" data-skin="Personnel">
            <div class="gdlr-core-pbf-element">
               <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                  <div class="gdlr-core-title-item-title-wrap clearfix">
                     <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #1a1a1a ;">Administrative Personnel</h3>
                  </div>
               </div>
            </div>
            <div class="gdlr-core-pbf-element">
                     ...
                     <div class="gdlr-core-personnel-list clearfix">
                        ...
                        <div class="gdlr-core-personnel-list-content-wrap">
                           ...
                           <div class="gdlr-core-personnel-info">
                              <div class="kingster-personnel-info-list kingster-type-office"><i class="kingster-personnel-info-list-icon fa fa-building"></i>Office: B-320</div>
                              <div class="kingster-personnel-info-list kingster-type-phone"><i class="kingster-personnel-info-list-icon fa fa-phone"></i>(040) 2301 - 6600</div>
                              <div class="kingster-personnel-info-list kingster-type-email"><i class="kingster-personnel-info-list-icon fa fa-envelope-open"></i>srihari.dasaradhi@admin.iith.ac.in</div>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="gdlr-core-personnel-list clearfix">
                        ...
                        <div class="gdlr-core-personnel-list-content-wrap">
                           ...
                           <div class="gdlr-core-personnel-info">
                              <div class="kingster-personnel-info-list kingster-type-office"><i class="kingster-personnel-info-list-icon fa fa-building"></i>Office: B-320</div>
                              <div class="kingster-personnel-info-list kingster-type-phone"><i class="kingster-personnel-info-list-icon fa fa-phone"></i>(040) 2301 - 6600</div>
                              <div class="kingster-personnel-info-list kingster-type-email"><i class="kingster-personnel-info-list-icon fa fa-envelope-open"></i>maatla.vishal@admin.iith.ac.in</div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="gdlr-core-pbf-element">
               <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                  <div class="gdlr-core-title-item-title-wrap clearfix">
                     <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #1a1a1a ;">Technical Personnel</h3>
                  </div>
               </div>
            </div>
            <div class="gdlr-core-pbf-element">
                  ...
                  <div class="gdlr-core-personnel-list-column gdlr-core-column-60 gdlr-core-column-first gdlr-core-item-pdlr">
                     <div class="gdlr-core-personnel-list clearfix">
                        ...
                        <div class="gdlr-core-personnel-list-content-wrap">
                           ...
                           <div class="gdlr-core-personnel-info">
                              <div class="kingster-personnel-info-list kingster-type-office"><i class="kingster-personnel-info-list-icon fa fa-building"></i>Office: B-321</div>
                              <div class="kingster-personnel-info-list kingster-type-phone"><i class="kingster-personnel-info-list-icon fa fa-phone"></i>(040) 2301 - 8562</div>
                              <div class="kingster-personnel-info-list kingster-type-email"><i class="kingster-personnel-info-list-icon fa fa-envelope-open"></i>anand.v@math.iith.ac.in</div>
                           </div>
                        </div>
                     </div>
                  </div>
