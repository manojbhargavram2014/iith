...
<div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/shutterstock_361397258.jpg) ;">
   ...
   <div class="kingster-page-title-container kingster-container">
      <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 390px ;padding-bottom: 55px ;">
         ...
         <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;">Master of Sciences</h1>
      </div>
   </div>
</div>
<div class="kingster-breadcrumbs">
   <div class="kingster-breadcrumbs-container kingster-container">
      <div class="kingster-breadcrumbs-item kingster-item-pdlr">
         ...
         &gt;
         <span property="itemListElement" typeof="ListItem">
            <span property="name">Master of Sciences</span>
   ...
   <div class="gdlr-core-page-builder-body">
    ...
    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
        <div class="gdlr-core-text-box-item-content">
            <p>The department has been running a Master of Sciences programme since the academic year 2013-14 with specialisation in two streams, viz., ‘Mathematics’ and ‘Mathematics and Computing.’</p>
            <p>The objective of the M.Sc Mathematics program is to provide students with a strong theoretical background in mathematics for pursuing research in both pure and applied mathematics.</p>
            <p>The M.Sc Mathematics and Computing program aims to produce students with a good-firm background in theoretical and applied mathematics, supplemented with the required computational skills. Students have the flexibility to pursue higher studies or orient themselves towards a career in the industry.</p>
            <p>Salient features of the M.Sc program:</p>
            <ul>
                <li>The first semester is common to both the streams.</li>
                <li>Freedom to choose between two streams: Mathematics or Mathematics and Computing.</li>
                <li>Streams based on the electives chosen in the 2nd–4th semesters.</li>
                <li>Sufficient emphasis on building a firm foundational knowledge.</li>
                <li>Exposure to research through mandatory project work for all students.</li>
                <li>Students are free to pursue interests in both streams.</li>
            </ul>
        </div>
    </div>
</div>
                  ...
                  <div class="gdlr-core-pbf-element">
                     <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px ;">
                        <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                           <p>Wondering why do M.Sc at IIT Hyderabad? Click on the icon above or the link below to know all the details about the programme at a glance.</p>
                        </div>
                     </div>
                  </div>
                  <div class="gdlr-core-pbf-element">
                  ...
                  <div class="gdlr-core-pbf-element">
                     <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 55px ;"><a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" target="_blank" href="https://math.iith.ac.in/pdfs/MnCBrochure2022.pdf" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px 29px 18px 32px;text-transform: none ;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;"><span class="gdlr-core-content" >Download Ciruculum</span><i class="gdlr-core-pos-right fa fa-file-pdf-o" style="font-size: 14px ;"  ></i></a></div>
                  </div>
               </div>
            </div>
            <div class="gdlr-core-pbf-sidebar-right gdlr-core-column-extend-right  kingster-sidebar-area gdlr-core-column-20 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height" style="padding: 30px 0px 30px 0px;">
               <div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                  <div id="gdlr-core-custom-menu-widget-6" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                     <h3 class="kingster-widget-title">Master of Sciences</h3>
