...
<div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align">
   ...
   <div class="kingster-page-title-container kingster-container">
      <div class="kingster-page-title-content kingster-item-pdlr">
         <h1 class="kingster-page-title">Post Doctoral</h1>
      </div>
   </div>
</div>
<div class="kingster-breadcrumbs">
   <div class="kingster-breadcrumbs-container kingster-container">
      <div class="kingster-breadcrumbs-item kingster-item-pdlr">
         ...
         &gt; 
         <span property="itemListElement" typeof="ListItem">
            <span property="name">Post Doctoral</span>
                     ...
                     <div class="gdlr-core-personnel-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-personnel-item-style-medium gdlr-core-personnel-style-medium">
                        <div class="">
                           <div class="gdlr-core-pbf-element mt-5">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #1a1a1a ;">Doctoral Students</h3>
                                 </div>
                              </div>
                           </div>
                           <div class="gdlr-core-pbf-element">
                                        ...
                                        <div class="gdlr-core-personnel-list clearfix">
                                            ...
                                            <div class="gdlr-core-personnel-list-content-wrap">
                                                ...
                                                <div class="gdlr-core-personnel-list-content">
                                                    <p>Area of Interest: Partial Differential Equations</p>
                                                    <p>Supervisor: Dr. Bhakti Bhusan Manna</p>
                                                    <p>Email: ma17resch11001@iith.ac.in</p>
                           ...
                           <div class="gdlr-core-pbf-element mt-5">
                              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #1a1a1a ;">Recently graduated</h3>
                                 </div>
                              </div>
                           </div>
                           <div class="gdlr-core-pbf-element">
